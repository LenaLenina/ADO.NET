...
namespace TableAdaptersWork.ShopDBTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([CustomerNo] = @Original_CustomerNo))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([FName], [LName], [MName], [Address1], [Address2]," +
                " [City], [Phone], [DateInSystem]) VALUES (@FName, @LName, @MName, @Address1, @Ad" +
                "dress2, @City, @Phone, @DateInSystem)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customers] SET [FName] = @FName, [LName] = @LName, [MName] = @MName" +
                ", [Address1] = @Address1, [Address2] = @Address2, [City] = @City, [Phone] = @Pho" +
                "ne, [DateInSystem] = @DateInSystem WHERE (([CustomerNo] = @Original_CustomerNo))" +
                "";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TableAdaptersWork.Properties.Settings.Default.ShopDBConnectionString;
        }
        ...
        public virtual int Delete(int Original_CustomerNo) {
        ...
        public virtual int Update(string FName, string LName, string MName, string Address1, string Address2, string City, string Phone, global::System.Nullable<global::System.DateTime> DateInSystem, int Original_CustomerNo) {
            if ((FName == null)) {
                throw new global::System.ArgumentNullException("FName");
            }
            else {
